...
export class TableTemplateComponent implements OnInit {
  ...
  resetInput(value,obj){
    ...
    else if(value=='status')
    {
      ...
      // console.log('value dropdown',this.header[4].filter.value);
      // this.onFilterApplied(obj,this.header[4]);
      // document.getElementById('drop').setAttribute('[selected]','all');
    }
  }
 ...
 reportIssue(){
  ...
  // console.log("feedback = ", this.model.userFeedback)
...
// console.log("json = ",this.json)
  ...
  ngOnInit() {
      ...
      // console.log('4th header',this.header[4]);
    }
