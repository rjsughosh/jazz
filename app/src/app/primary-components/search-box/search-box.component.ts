...
export class SearchBoxComponent implements OnInit {
  ...
  onServiceSearchkey(searchString,searchVal){
    ...
    //  console.log("emit from keyenter = " ,"searchString = ",searchString,"keyCode = ",this.keyCodeVal)
    }
  };
  ...
  onServiceSearchngModel(searchString,searchVal){
    ...
    if(searchVal == ""){
     ...
     this.onChange.emit({"searchString":searchString,"keyCode":this.keyCodeVal})
    //  console.log("emit from ngModel = " ,"searchString = ",searchString,"keyCode = ",this.keyCodeVal)
  };
